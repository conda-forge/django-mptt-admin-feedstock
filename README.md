About django-mptt-admin-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-mptt-admin-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-mptt-admin-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-mptt-admin
# for installing globally
pixi global install django-mptt-admin
```
...
It is possible to list all of the versions of `django-mptt-admin` available on your platform:
...
```
pixi search django-mptt-admin --channel conda-forge
```
